        ...
        const stoneData = [
            {
                ...
                color: 0x4a5d4a,
                size: 2,
                modelPath: "models/chondrite.glb", // GLB 파일 경로
            ...
            },
            {
                ...
                color: 0x4169E1,
                size: 2.2,
                modelPath: "models/blue-crystal.glb",
            ...
            },
            {
                ...
                color: 0x4169E1,
                size: 2.2,
                modelPath: "models/heart-crystal.glb",
                image: "images/heart-crystal.png"
            }
        ];
        ...
        function createSpaceSphere() {
            ...
            const spaceImagePath = 'img/space14.png'; // 실제 이미지 경로로 변경
